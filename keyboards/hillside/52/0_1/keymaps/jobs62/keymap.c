...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_AZERTY] = LAYOUT(
     ...
     _______, KC_BSLS, ALT_GR,           RY_NUM, LY_NAV,  OSM_SFT, KC_ENT,        KC_SPC, RY_NAV, KC_MINS, KC_SLSH,          KC_LEFT, KC_DOWN, KC_RGHT
    ),
    [_NUM] = LAYOUT(
    ...
    [_NUMPAD] = LAYOUT(
     _______, _______, _______, _______, _______, _______,                                        _______, KC_7   , KC_8   , KC_9   , KC_KP_PLUS, KC_PGUP,
     _______, _______, _______, _______, _______, _______,                                        _______, KC_4   , KC_5   , KC_6   , KC_KP_MINUS, KC_PGDN,
     _______, _______, _______, _______, _______, _______, _______,                      _______, _______, KC_1   , KC_2   , KC_3   , KC_KP_ENT, _______,
